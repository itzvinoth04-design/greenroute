 ...
 */
export function generatePDFReportBuffer(reportData: ReportData): Buffer {
  const doc = new jsPDF({
  ...
  doc.text(
    'GreenRoute Platform - Verified with IBM Granite Foundation Models & SDG 11 Urban Mobility Standards',
    14,
    285
  );
